...
1. [Implement an infinite sum function.](/blog/closure-questions-for-frontend-interviews/infinite-sum 'Classic Infinite Sum implementation using closures')
1. [Implement a make counter function.](/blog/closure-questions-for-frontend-interviews/make-counter-function 'Classic Make Counter implementation using closures')
