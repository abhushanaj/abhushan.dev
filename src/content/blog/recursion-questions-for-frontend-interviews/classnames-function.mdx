---
seoMetaData:
  title: 'Implement classnames function'
  description: 'Implement classnames function using recursion'
  ogImage: '/open-graph/blogs/get-elements-by-function.webp'
  ogImageAlt: 'Implement classnames function using recursion'
title: 'Implement classnames function'
...
We assume the possible values are strings, boolean, arrays and objects.
