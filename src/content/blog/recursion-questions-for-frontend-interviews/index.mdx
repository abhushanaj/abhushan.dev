---
seoMetaData:
  title: '({{year}} Updated)! Recursion Questions for Frontend Interviews'
  description: 'Practice from real interview questions to master recursion based challenges for your next frontend interview in {{year}} '
...
1. Understanding whether you will operate on nodesor elements on DOM, so you can use the correct API's for transversing children and siblings.
...
1. [Implement getElementsBy function](/blog/recursion-questions-for-frontend-interviews/get-elements-by-function/ 'getElementsBy function using recursion')
...
Whenever the problem state would expect you to deal with DOM transversal, be clear on whether you are operating on **nodes** or **elements** and use the appropriate API's to avoid unnecessary work.
