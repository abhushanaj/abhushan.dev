...
seoMetaData:
  ...
  description: 'Implement a deepEqual function using recursion'
  ogImage: '/open-graph/blogs/implement-a-deep-seal-object-function.webp'
  ogImageAlt: 'Implement a deepEqual function using recursion'
title: 'Implement a deepEqual function'
...
In above implementation I have used a utility function called <InlineCode code="isPojo()"/> to determine if the value is an plain old javascript object. It can be implemented as follows
.
