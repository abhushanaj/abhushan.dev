...
seoMetaData:
  ...
  description: 'Solution for implementation of deepFlattenObject utility function question using recursion asked in frontend interviews.'
  ogImage: '/open-graph/blogs/implement-a-deep-flatten-object-function.webp'
  ogImageAlt: 'Implementation of deepFlattenObject function using recursion'
title: 'Implement a deepFlattenObject function'
