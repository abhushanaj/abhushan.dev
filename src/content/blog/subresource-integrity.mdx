...
The **integrity** attribute on the script or link tag is made of of two parts seperated by a hypen.
...
You can use this script to generate the integrity value for SRI for any type of remote resource you want. These hash ouput will always match until the input has been altered of tampered with.
